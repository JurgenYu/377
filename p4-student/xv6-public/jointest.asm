...
int main(int argc, char *argv[])
{
  ...
  int freed_pid = join();
   f:	e8 76 03 00 00       	call   38a <join>
  if (freed_pid != -1)
  ...
  2d:	68 00 10 00 00       	push   $0x1000
  32:	e8 33 03 00 00       	call   36a <sbrk>
...
00000080 <func>:
{
  ...
  exit();
  86:	e8 57 02 00 00       	call   2e2 <exit>
  8b:	66 90                	xchg   %ax,%ax
  8d:	66 90                	xchg   %ax,%ax
  8f:	90                   	nop
 ...
 3b9:	85 d2                	test   %edx,%edx
{
 ...
 3e7:	f7 f1                	div    %ecx
 3e9:	0f b6 92 34 08 00 00 	movzbl 0x834(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb 2b 08 00 00       	mov    $0x82b,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 621:	a1 f8 0a 00 00       	mov    0xaf8,%eax
{
 ...
 65d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 65f:	a3 f8 0a 00 00       	mov    %eax,0xaf8
}
 664:	5b                   	pop    %ebx
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
 ...
 676:	72 ce                	jb     646 <free+0x26>
{
 ...
 697:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 69a:	a3 f8 0a 00 00       	mov    %eax,0xaf8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 15 f8 0a 00 00    	mov    0xaf8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 47                	jae    748 <malloc+0x98>
    ...
    if(p == freep)
 701:	39 05 f8 0a 00 00    	cmp    %eax,0xaf8
 ...
 726:	e8 f5 fe ff ff       	call   620 <free>
  return freep;
 72b:	8b 15 f8 0a 00 00    	mov    0xaf8,%edx
 ...
 754:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 757:	89 15 f8 0a 00 00    	mov    %edx,0xaf8
}
 ...
 769:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 f8 0a 00 00 fc 	movl   $0xafc,0xaf8
 777:	0a 00 00 
 77a:	c7 05 fc 0a 00 00 fc 	movl   $0xafc,0xafc
 781:	0a 00 00 
    base.s.size = 0;
 784:	b8 fc 0a 00 00       	mov    $0xafc,%eax
 789:	c7 05 00 0b 00 00 00 	movl   $0x0,0xb00
 790:	00 00 00 
