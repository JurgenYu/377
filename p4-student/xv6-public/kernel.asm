...
80100d3c:	e8 0f 60 00 00       	call   80106d50 <freevm>
  return 0;
...
80101ec8:	68 e2 77 10 80       	push   $0x801077e2
...
80102e83:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e86:	e8 f5 3a 00 00       	call   80106980 <switchkvm>
  seginit();
80102e8b:	e8 60 3a 00 00       	call   801068f0 <seginit>
  lapicinit();
...
80102ec1:	e8 8a 3f 00 00       	call   80106e50 <kvmalloc>
  mpinit();        // detect other processors
80102ec6:	e8 75 01 00 00       	call   80103040 <mpinit>
  lapicinit();     // interrupt controller
80102ecb:	e8 60 f7 ff ff       	call   80102630 <lapicinit>
  seginit();       // segment descriptors
80102ed0:	e8 1b 3a 00 00       	call   801068f0 <seginit>
  picinit();       // disable pic
...
80102ee4:	e8 d7 2c 00 00       	call   80105bc0 <uartinit>
  pinit();         // process table
...
8010364c:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103652:	e8 f9 0e 00 00       	call   80104550 <release>
...
80103674:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103677:	c7 40 14 ff 57 10 80 	movl   $0x801057ff,0x14(%eax)
  p->context = (struct context*)sp;
...
80103686:	e8 15 0f 00 00       	call   801045a0 <memset>
...
801036aa:	e8 a1 0e 00 00       	call   80104550 <release>
}
...
801036db:	e8 70 0e 00 00       	call   80104550 <release>
...
80103730:	e8 1b 0c 00 00       	call   80104350 <initlock>
}
...
801037ad:	68 b8 76 10 80       	push   $0x801076b8
...
801037e4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801037e7:	e8 d4 0b 00 00       	call   801043c0 <pushcli>
  c = mycpu();
801037ec:	e8 4f ff ff ff       	call   80103740 <mycpu>
  p = c->proc;
801037f1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801037f7:	e8 04 0c 00 00       	call   80104400 <popcli>
}
...
80103856:	e8 45 0d 00 00       	call   801045a0 <memset>
...
801038b5:	e8 c6 0e 00 00       	call   80104780 <safestrcpy>
  p->cwd = namei("/");
...
80103905:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103908:	e8 b3 0a 00 00       	call   801043c0 <pushcli>
  c = mycpu();
8010390d:	e8 2e fe ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103912:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103918:	e8 e3 0a 00 00       	call   80104400 <popcli>
  if(n > 0){
...
8010392c:	e8 6f 30 00 00       	call   801069a0 <switchuvm>
  return 0;
...
80103986:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103989:	e8 32 0a 00 00       	call   801043c0 <pushcli>
  c = mycpu();
8010398e:	e8 ad fd ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103993:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103999:	e8 62 0a 00 00       	call   80104400 <popcli>
  if((np = allocproc()) == 0){
...
801039b8:	e8 e3 34 00 00       	call   80106ea0 <copyuvm>
...
80103ace:	e8 bd 09 00 00       	call   80104490 <acquire>
...
80103af0:	e8 ab 2e 00 00       	call   801069a0 <switchuvm>
...
80103afb:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103b02:	e8 d4 0c 00 00       	call   801047db <swtch>
      switchkvm();
80103b07:	e8 74 2e 00 00       	call   80106980 <switchkvm>
      c->proc = 0;
...
80103b2c:	e8 1f 0a 00 00       	call   80104550 <release>
    sti();
...
80103b44:	53                   	push   %ebx
  pushcli();
80103b45:	e8 76 08 00 00       	call   801043c0 <pushcli>
  c = mycpu();
80103b4a:	e8 f1 fb ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103b4f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b55:	e8 a6 08 00 00       	call   80104400 <popcli>
  if(!holding(&ptable.lock))
80103b5a:	83 ec 0c             	sub    $0xc,%esp
80103b5d:	68 20 2d 11 80       	push   $0x80112d20
80103b62:	e8 f9 08 00 00       	call   80104460 <holding>
...
80103ba3:	e8 33 0c 00 00       	call   801047db <swtch>
  mycpu()->intena = intena;
...
80103c06:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103c09:	e8 b2 07 00 00       	call   801043c0 <pushcli>
  c = mycpu();
80103c0e:	e8 2d fb ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103c13:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103c19:	e8 e2 07 00 00       	call   80104400 <popcli>
  if(curproc == initproc)
...
80103c72:	e8 19 08 00 00       	call   80104490 <acquire>
...
80103d3c:	e8 4f 07 00 00       	call   80104490 <acquire>
  pushcli();
80103d41:	e8 7a 06 00 00       	call   801043c0 <pushcli>
  c = mycpu();
80103d46:	e8 f5 f9 ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103d4b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d51:	e8 aa 06 00 00       	call   80104400 <popcli>
...
80103d69:	e8 e2 07 00 00       	call   80104550 <release>
}
...
80103d8c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103d8f:	e8 2c 06 00 00       	call   801043c0 <pushcli>
  c = mycpu();
80103d94:	e8 a7 f9 ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103d99:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d9f:	e8 5c 06 00 00       	call   80104400 <popcli>
  if(p == 0)
...
80103dc0:	e8 cb 06 00 00       	call   80104490 <acquire>
    release(lk);
80103dc5:	89 34 24             	mov    %esi,(%esp)
80103dc8:	e8 83 07 00 00       	call   80104550 <release>
  p->chan = chan;
...
80103dea:	e8 61 07 00 00       	call   80104550 <release>
    acquire(lk);
...
80103dfb:	5d                   	pop    %ebp
    acquire(lk);
80103dfc:	e9 8f 06 00 00       	jmp    80104490 <acquire>
...
80103ed2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103ed9:	e8 72 2e 00 00       	call   80106d50 <freevm>
        release(&ptable.lock);
...
80103efe:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103f05:	e8 46 06 00 00       	call   80104550 <release>
        return pid;
...
80103f23:	e8 28 06 00 00       	call   80104550 <release>
      return -1;
...
80103f3f:	e8 4c 05 00 00       	call   80104490 <acquire>
...
80103f80:	c9                   	leave  
  release(&ptable.lock);
80103f81:	e9 ca 05 00 00       	jmp    80104550 <release>
...
80103f9f:	e8 ec 04 00 00       	call   80104490 <acquire>
...
80103fdb:	e8 70 05 00 00       	call   80104550 <release>
      return 0;
...
80103ff8:	e8 53 05 00 00       	call   80104550 <release>
  return -1;
...
8010402b:	68 fb 79 10 80       	push   $0x801079fb
...
80104058:	8b 14 85 e0 76 10 80 	mov    -0x7fef8920(,%eax,4),%edx
      state = "???";
...
80104098:	e8 d3 02 00 00       	call   80104370 <getcallerpcs>
...
801040d6:	83 ec 2c             	sub    $0x2c,%esp
  pushcli();
801040d9:	e8 e2 02 00 00       	call   801043c0 <pushcli>
  c = mycpu();
...
801040e9:	89 55 d4             	mov    %edx,-0x2c(%ebp)
  popcli();
801040ec:	e8 0f 03 00 00       	call   80104400 <popcli>
  int i;
  struct proc *np;
  struct proc *curproc = myproc();
...
8010415d:	e8 6e 2e 00 00       	call   80106fd0 <copyout>
...
801041d9:	e8 a2 05 00 00       	call   80104780 <safestrcpy>

  acquire(&ptable.lock);
801041de:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801041e5:	e8 a6 02 00 00       	call   80104490 <acquire>
...
801041f8:	e8 53 03 00 00       	call   80104550 <release>
...
8010422a:	68 f8 76 10 80       	push   $0x801076f8
...
80104285:	e8 f6 fa ff ff       	call   80103d80 <sleep>
  while (lk->locked) {
...
80104293:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104299:	e8 42 f5 ff ff       	call   801037e0 <myproc>
...
801042e4:	e8 47 fc ff ff       	call   80103f30 <wakeup>
  release(&lk->lk);
...
80104323:	e8 b8 f4 ff ff       	call   801037e0 <myproc>
...
801043df:	e8 5c f3 ff ff       	call   80103740 <mycpu>
801043e4:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
801043ea:	e8 51 f3 ff ff       	call   80103740 <mycpu>
...
8010442c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104430:	e8 0b f3 ff ff       	call   80103740 <mycpu>
...
80104445:	68 03 77 10 80       	push   $0x80107703
8010444a:	e8 41 bf ff ff       	call   80100390 <panic>
    panic("popcli");
8010444f:	83 ec 0c             	sub    $0xc,%esp
80104452:	68 1a 77 10 80       	push   $0x8010771a
...
80104478:	e8 c3 f2 ff ff       	call   80103740 <mycpu>
...
801044d4:	e8 67 f2 ff ff       	call   80103740 <mycpu>
...
80104537:	68 21 77 10 80       	push   $0x80107721
...
8010458c:	68 29 77 10 80       	push   $0x80107729
...
801047f7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801047fa:	e8 e1 ef ff ff       	call   801037e0 <myproc>
...
80104837:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010483a:	e8 a1 ef ff ff       	call   801037e0 <myproc>
...
801048a5:	e8 36 ef ff ff       	call   801037e0 <myproc>
...
801048b3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801048b6:	e8 25 ef ff ff       	call   801037e0 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
801048f8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
801048fb:	e8 e0 ee ff ff       	call   801037e0 <myproc>
...
80104994:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104997:	e8 44 ee ff ff       	call   801037e0 <myproc>
...
801049ac:	8b 14 85 60 77 10 80 	mov    -0x7fef88a0(,%eax,4),%edx
...
801049d0:	68 31 77 10 80       	push   $0x80107731
...
80104b24:	68 d8 77 10 80       	push   $0x801077d8
...
80104b3c:	68 d7 77 10 80       	push   $0x801077d7
...
80104b55:	68 cb 77 10 80       	push   $0x801077cb
...
80104b6a:	68 da 77 10 80       	push   $0x801077da
80104b6f:	e8 1c b8 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104b74:	83 ec 0c             	sub    $0xc,%esp
80104b77:	68 bc 77 10 80       	push   $0x801077bc
...
80104f69:	58                   	pop    %eax
80104f6a:	5a                   	pop    %edx
80104f6b:	68 d8 77 10 80       	push   $0x801077d8
...
80104f84:	68 d7 77 10 80       	push   $0x801077d7
...
801055f3:	5d                   	pop    %ebp
  return wait();
801055f4:	e9 47 e8 ff ff       	jmp    80103e40 <wait>
...
80105676:	e8 85 e2 ff ff       	call   80103900 <growproc>
...
801056ed:	e8 8e e6 ff ff       	call   80103d80 <sleep>
  while(ticks - ticks0 < n){
...
80105827:	c7 04 c5 a2 4c 11 80 	movl   $0x8e000008,-0x7feeb35e(,%eax,8)
8010582e:	08 00 00 8e 
80105832:	66 89 14 c5 a0 4c 11 	mov    %dx,-0x7feeb360(,%eax,8)
80105839:	80 
8010583a:	c1 ea 10             	shr    $0x10,%edx
8010583d:	66 89 14 c5 a6 4c 11 	mov    %dx,-0x7feeb35a(,%eax,8)
80105844:	80 
  for(i = 0; i < 256; i++)
...
80105854:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105857:	c7 05 a2 4e 11 80 08 	movl   $0xef000008,0x80114ea2
8010585e:	00 00 ef 
  initlock(&tickslock, "time");
80105861:	68 1d 78 10 80       	push   $0x8010781d
80105866:	68 60 4c 11 80       	push   $0x80114c60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010586b:	66 a3 a0 4e 11 80    	mov    %ax,0x80114ea0
80105871:	c1 e8 10             	shr    $0x10,%eax
80105874:	66 a3 a6 4e 11 80    	mov    %ax,0x80114ea6
  initlock(&tickslock, "time");
8010587a:	e8 d1 ea ff ff       	call   80104350 <initlock>
}
...
8010589b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010589f:	b8 a0 4c 11 80       	mov    $0x80114ca0,%eax
...
801058e0:	ff 24 85 c4 78 10 80 	jmp    *-0x7fef873c(,%eax,4)
...
80105945:	68 80 78 10 80       	push   $0x80107880
...
801059dd:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
801059e0:	e8 ab ef ff ff       	call   80104990 <syscall>
    if(myproc()->killed)
...
80105a34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105a38:	e8 d3 cb ff ff       	call   80102610 <kbdintr>
    lapiceoi();
...
80105a58:	e8 53 02 00 00       	call   80105cb0 <uartintr>
    lapiceoi();
80105a5d:	e8 ee cc ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
...
80105a87:	68 28 78 10 80       	push   $0x80107828
80105a8c:	e8 cf ab ff ff       	call   80100660 <cprintf>
    lapiceoi();
80105a91:	e8 ba cc ff ff       	call   80102750 <lapiceoi>
    break;
...
80105af4:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
80105afb:	e8 30 e4 ff ff       	call   80103f30 <wakeup>
      release(&tickslock);
80105b00:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
80105b07:	e8 44 ea ff ff       	call   80104550 <release>
...
80105b25:	68 4c 78 10 80       	push   $0x8010784c
80105b2a:	e8 31 ab ff ff       	call   80100660 <cprintf>
      panic("trap");
80105b2f:	83 c4 14             	add    $0x14,%esp
80105b32:	68 22 78 10 80       	push   $0x80107822
...
80105b95:	e8 d6 cb ff ff       	call   80102770 <microdelay>
...
80105c2c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105c2f:	bb 44 79 10 80       	mov    $0x80107944,%ebx
  ioapicenable(IRQ_COM1, 0);
80105c34:	6a 00                	push   $0x0
80105c36:	6a 04                	push   $0x4
80105c38:	e8 93 c6 ff ff       	call   801022d0 <ioapicenable>
...
80106784:	e8 37 bd ff ff       	call   801024c0 <kalloc>
...
8010679a:	e8 01 de ff ff       	call   801045a0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010683d:	68 4c 79 10 80       	push   $0x8010794c
...
80106894:	e8 77 ba ff ff       	call   80102310 <kfree>
      *pte = 0;
...
801068e2:	68 e6 72 10 80       	push   $0x801072e6
...
80106acb:	77 49                	ja     80106b16 <inituvm+0x66>
  mem = kalloc();
80106acd:	e8 ee b9 ff ff       	call   801024c0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106b19:	68 91 79 10 80       	push   $0x80107991
...
80106ba1:	e8 ba ad ff ff       	call   80101960 <readi>
...
80106c3b:	e8 60 d9 ff ff       	call   801045a0 <memset>
...
80106c69:	0f 86 81 00 00 00    	jbe    80106cf0 <allocuvm+0x100>
    mem = kalloc();
80106c6f:	e8 4c b8 ff ff       	call   801024c0 <kalloc>
    if(mem == 0){
...
80106c7d:	68 c9 79 10 80       	push   $0x801079c9
...
80106cb3:	68 e1 79 10 80       	push   $0x801079e1
...
80106cdb:	e8 30 b6 ff ff       	call   80102310 <kfree>
      return 0;
...
80106d9e:	e8 6d b5 ff ff       	call   80102310 <kfree>
...
80106db3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106db4:	e9 57 b5 ff ff       	jmp    80102310 <kfree>
    panic("freevm: no pgdir");
80106db9:	83 ec 0c             	sub    $0xc,%esp
80106dbc:	68 fd 79 10 80       	push   $0x801079fd
...
80106df0:	e8 ab d7 ff ff       	call   801045a0 <memset>
...
80106e5b:	a3 a4 54 11 80       	mov    %eax,0x801154a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106e8f:	68 0e 7a 10 80       	push   $0x80107a0e
...
80106ee0:	e8 6b d7 ff ff       	call   80104650 <memmove>
...
80106f35:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80106f38:	e8 83 b5 ff ff       	call   801024c0 <kalloc>
